...
module.exports = function createEntry(rawHeader, extract, callback) {
  var header = zipUtils.parseExternalFileAttributes(rawHeader.externalFileAttributes, rawHeader.versionMadeBy >> 8);
  header.name = rawHeader.fileName;
  header.mtime = zipUtils.convertDateTime(rawHeader.lastModFileDate, rawHeader.lastModFileTime);
